...
const hei = navigator.geolocation.getCurrentPosition((pos) => {
    const location = success(pos)
    
    console.log(location.current)
});

console.log(hei.location)
...
/* let dataIWantToUse = null;

function fillWantedData(){
    dataIWantToUse = 'important data';
}

fillWantedData();

export function getWantedData(){
    return dataIWantToUse;
} */